<?php echo form_open('_penyedium/edit/'.$_penyedium['id_penyedia'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_jenis_penyedia" class="form-control">
				...
				{
					$selected = ($_jenis_penyedium['id_jenis_penyedia'] == $_penyedium['id_jenis_penyedia']) ? ' selected="selected"' : "";
