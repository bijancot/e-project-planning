<?php echo form_open('tr_belanja_rekening/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="Kd_Rek_1" class="form-control">
				...
				{
					$selected = ($ref_rek_1['Kd_Rek_1'] == $this->input->post('Kd_Rek_1')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="Kd_Rek_2" class="form-control">
				...
				{
					$selected = ($ref_rek_2['Kd_Rek_1'] == $this->input->post('Kd_Rek_2')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="Kd_Rek_3" class="form-control">
				...
				{
					$selected = ($ref_rek_3['Kd_Rek_1'] == $this->input->post('Kd_Rek_3')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="Kd_Rek_4" class="form-control">
				...
				{
					$selected = ($ref_rek_4['Kd_Rek_1'] == $this->input->post('Kd_Rek_4')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="Kd_Rek_5" class="form-control">
				...
				{
					$selected = ($ref_rek_5['Kd_Rek_1'] == $this->input->post('Kd_Rek_5')) ? ' selected="selected"' : "";
