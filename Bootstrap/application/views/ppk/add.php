<?php echo form_open('ppk/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="id_satker_ppk" value="<?php echo $this->input->post('id_satker_ppk'); ?>" class="form-control" id="id_satker_ppk" />
		</div>
	</div>
