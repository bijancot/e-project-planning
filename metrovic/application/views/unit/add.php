        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php endif ?>
					...
					<?php echo form_open('test-bootstrap/unit/add',array("class"=>"form-horizontal")); ?>
...
<div class="form-group">
	...
	<div class="col-md-8">
		<select name="kode_bidang" class="form-control">
			...
			{
				$selected = ($bidang['id_bidang'] == $this->input->post('kode_bidang')) ? ' selected="selected"' : "";

				echo '<option value="'.$bidang['id_bidang'].'" '.$selected.'>'.$bidang['nama_bidang'].'</option>';
			} 
			?>
		</select>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-8">
		<input type="text" name="nama_unit" value="<?php echo $this->input->post('nama_unit'); ?>" class="form-control" id="nama_unit" />
	</div>
</div>
